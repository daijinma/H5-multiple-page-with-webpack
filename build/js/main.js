...
/***/ function(module, exports, __webpack_require__) {
	...
	$.ajaxSettings.beforeSend = function (xhr, setting) {
	    return setting.url = setting.url.replace(/^\/\_api\/(.+)/, APIHOST + '/$1');
	};
	...
	router.map({
	    ...
	    '/detail/:id': {
	        name: 'detail',
	        component: function component(resolve) {
	            __webpack_require__.e/* require */(2, function(__webpack_require__) { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(34)]; (resolve.apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this));
	        }
	    },
	    '*': {
	        name: '404',
